  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 text-center text-4xl font-medium tracking-tight text-foreground md:text-7xl"
      >
        Immortalize your predictions <br /> on the Ethereum network <br /> &darr;	
      </motion.h1>
    </LampContainer>
  );
}
